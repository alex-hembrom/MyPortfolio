...
function App() {
  ...
  return (
    <div className="min-h-screen bg-background font-sans text-gray-200 selection:bg-purple-500 selection:text-white relative overflow-hidden">
      ...
      {/* FLOATING BACKGROUND TECH ICONS (TRUE ZERO-GRAVITY SPACE EFFECT) */}
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden opacity-[0.08] text-blue-300">
        
        {/* 1. SQL Database Icon */}
        <svg className="w-12 h-12 absolute top-[12%] left-[4%] animate-[space-float-1_9s_ease-in-out_infinite] text-blue-300" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 4.02 2 6.5v11C2 19.98 6.48 22 12 22s10-2.02 10-4.5v-11C22 4.02 17.52 2 12 2zM12 4c4.69 0 8 1.5 8 2.5s-3.31 2.5-8 2.5-8-1.5-8-2.5S7.31 4 12 4z"/></svg>
        
        {/* 2. Node.js Icon */}
        <svg className="w-11 h-11 text-green-400 absolute top-[25%] left-[18%] animate-[space-float-2_11s_ease-in-out_infinite]" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L2 7.8V16.2L12 22L22 16.2V7.8L12 2z"/></svg>
        
        {/* 3. MongoDB Leaf Icon */}
        <svg className="w-12 h-12 text-green-500 absolute top-[8%] right-[15%] animate-[space-float-3_8s_ease-in-out_infinite]" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 2C12 2 7 7.5 7 14C7 17.5 9.5 20 12 22C14.5 20 17 17.5 17 14C17 7.5 12 2 12 2Z M12 22V12"/>
        </svg>

        {/* 4. AI Chip Icon */}
        <svg className="w-10 h-10 text-purple-400 absolute top-[48%] left-[6%] animate-[space-float-1_10s_ease-in-out_infinite_reverse]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m16-6h2m-2 6h2M7 5h10a2 2 0 012 2v10a2 2 0 01-2 2H7a2 2 0 01-2-2V7a2 2 0 012-2z"/></svg>
        
        {/* 5. Java Coffee Cup Icon */}
        <svg className="w-14 h-14 text-red-400 absolute top-[35%] right-[8%] animate-[space-float-2_12s_ease-in-out_infinite_reverse]" fill="currentColor" viewBox="0 0 24 24">
          <path d="M16.5 13.5c0 1.5-1.5 2.5-4.5 2.5s-4.5-1-4.5-2.5v-4h9v4zm1-3.5h1.5c1 0 1.5.5 1.5 1.5s-.5 1.5-1.5 1.5H17.5v-3zM6 17.5h12v1.5H6v-1.5z"/><path d="M10 6c0-1.5 1-2 1-3 0 1.5-1 2-1 3zm3 0c0-1.5 1-2 1-3 0 1.5-1 2-1 3zm-1.5-1c0-1.5 1-2 1-3 0 1.5-1 2-1 3z"/>
        </svg>

        {/* 6. C Icon */}
        <svg className="w-12 h-12 text-blue-500 absolute top-[58%] right-[14%] animate-[space-float-3_9s_ease-in-out_infinite]" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm0-18c-4.411 0-8 3.589-8 8s3.589 8 8 8 8-3.589 8-8-3.589-8-8-8zm2.5 11.5c-.8.8-1.8 1.2-3 1.2-2.5 0-4.5-2-4.5-4.5S9 7.7 11.5 7.7c1.2 0 2.2.4 3 1.2l-1.4 1.4c-.4-.4-.9-.6-1.5-.6-1.4 0-2.5 1.1-2.5 2.5s1.1 2.5 2.5 2.5c.6 0 1.1-.2 1.5-.6l1.4 1.4z"/>
        </svg>

        {/* 7. Python Snake Icon */}
        <svg className="w-14 h-14 text-yellow-300 absolute top-[72%] left-[12%] animate-[space-float-1_13s_ease-in-out_infinite]" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12.01 2.01c-2.62 0-2.57 1.13-2.57 1.13l-.01 2.68h2.42v1h-4.54s-3.09.06-3.09 2.86c0 2.78 2.77 2.84 2.77 2.84h1.02v-1.36s-.04-1.68 1.64-1.68h2.47s1.55-.03 1.55-1.58V3.71s.09-1.7-1.66-1.7zm-1.5.58c.32 0 .58.26.58.58 0 .32-.26.58-.58.58-.32 0-.58-.26-.58-.58 0-.32.26-.58.58-.58zm-1.8 7.39S6.82 9.94 6.82 11.53v1.62s-.09 1.69 1.65 1.69c2.62 0 2.57-1.12 2.57-1.12l.01-1.14H8.63v-1.01h4.54s3.09-.06 3.09-2.86c0-2.78-2.77-2.84-2.77-2.84h-1.02v1.36s.04 1.68-1.64 1.68H8.36s-1.55.03-1.55 1.58v4.19s-.09 1.7 1.66 1.7zm3.52 4.25c-.32 0-.58-.26-.58-.58 0-.32.26-.58.58-.58.32 0 .58.26.58.58 0 .32-.26.58-.58.58z"/>
        </svg>

        {/* 8. React Icon */}
        <svg className="w-14 h-14 text-blue-400 absolute top-[22%] right-[25%] animate-[space-float-2_10s_ease-in-out_infinite]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><ellipse cx="12" cy="12" rx="10" ry="4" transform="rotate(30 12 12)"></ellipse><ellipse cx="12" cy="12" rx="10" ry="4" transform="rotate(90 12 12)"></ellipse><ellipse cx="12" cy="12" rx="10" ry="4" transform="rotate(150 12 12)"></ellipse></svg>
        
        {/* 9. JavaScript Icon */}
        <svg className="w-12 h-12 text-yellow-400 absolute top-[82%] right-[22%] animate-[space-float-3_11s_ease-in-out_infinite_reverse]" fill="currentColor" viewBox="0 0 24 24">
          <path d="M4.5 4.5v15h15v-15h-15zm8.5 11.5c0 1.2-.9 2-2.5 2-1.2 0-2-.5-2.5-1l1-.8c.4.4.9.6 1.3.6.5 0 .8-.2.8-.5 0-.4-.4-.5-1.2-.8-1.1-.4-2-.9-2-2 0-1.1.9-2 2.3-2 1 0 1.6.4 2 .8l-1 .9c-.3-.3-.6-.5-1-.5-.5 0-.8.2-.8.5 0 .3.3.4 1 .7 1.3.4 2.1 1 2.1 2.1zm3.5.1c0 1.3-1 2-2.6 2s-2.5-.7-2.5-2v-4.5h1.5v4.5c0 .6.4 1 1 1s1-.4 1-1v-4.5h1.6v4.6z" />
        </svg>

        {/* 10. VS Code Icon */}
        <svg className="w-12 h-12 text-blue-400 absolute top-[68%] right-[5%] animate-[space-float-1_8s_ease-in-out_infinite]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"/></svg>
        
        {/* 11. C# Icon */}
        <svg className="w-11 h-11 text-purple-400 absolute top-[42%] left-[24%] animate-[space-float-2_9s_ease-in-out_infinite]" fill="currentColor" viewBox="0 0 24 24">
          <path d="M10 15c-.8.8-1.8 1.2-3 1.2-2.5 0-4.5-2-4.5-4.5S4.5 7.2 7 7.2c1.2 0 2.2.4 3 1.2l-1.4 1.4c-.4-.4-.9-.6-1.5-.6-1.4 0-2.5 1.1-2.5 2.5s1.1 2.5 2.5 2.5c.6 0 1.1-.2 1.5-.6L10 15zm10-5h-1.5v-2h-1.5v2h-1.5v-2h-1.5v2H13v1.5h1.5v1.5H13V15h1.5v2h1.5v-2h1.5v2h1.5v-2H20v-1.5h-1.5v-1.5H20V10zM17 11.5v1.5h-1.5v-1.5H17z"/>
        </svg>

        {/* 12. Firebase Icon */}
        <svg className="w-11 h-11 text-yellow-400 absolute top-[88%] left-[28%] animate-[space-float-3_12s_ease-in-out_infinite]" fill="currentColor" viewBox="0 0 24 24"><path d="M13.5 2a.5.5 0 0 0-.5.5v3.25L10 2.5a.5.5 0 0 0-.85.35v6.9L6 6.5a.5.5 0 0 0-.8.4v10.6a6.5 6.5 0 0 0 13 0V7.5a.5.5 0 0 0-.8-.4l-3.9 3.25V2.5a.5.5 0 0 0-.5-.5z"/></svg>
      </div>

      {/* CUSTOM CSS: FLOATING SPACE EFFECT & WRITING REVEAL */}
      <style>
        {`
          /* SPACE FLOATING KEYFRAMES */
          ...
          /* UNIFIED WRITING/PRINT EFFECT FOR NAME & BIO */
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#0B0C10]/70 backdrop-blur-lg border-b border-gray-800/50 shadow-sm transition-all">
        <nav className="max-w-[1400px] mx-auto px-6 md:px-12 py-5 flex justify-between items-center relative z-50">
          ...
          <a 
            ...
            className="text-2xl font-extrabold tracking-tight text-white z-50 cursor-pointer inline-block transform hover:-translate-y-0.5 hover:drop-shadow-[0_0_12px_rgba(255,255,255,0.6)] transition-all duration-300"
          >
            Alex.
          </a>
          ...
          <div className="hidden md:flex items-center gap-12 text-sm font-medium text-gray-400 absolute left-1/2 -translate-x-1/2">
            ...
            <a href="#achievements" className="group relative inline-block transform hover:text-white hover:-translate-y-1 transition-all duration-300">
              Achievements
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-500 transition-all duration-300 group-hover:w-full"></span>
            </a>
          </div>

          {/* Right: Call to Action Button (Desktop) */}
        ...
        <div className={`fixed inset-0 bg-[#0B0C10]/95 backdrop-blur-xl z-40 transition-transform duration-300 ease-in-out flex flex-col items-center justify-center space-y-8 ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'} md:hidden`}>
          <a href="#home" onClick={() => setIsMobileMenuOpen(false)} className="text-2xl font-bold text-white hover:text-blue-400 transition-colors">Home</a>
          <a href="#about" onClick={() => setIsMobileMenuOpen(false)} className="text-2xl font-bold text-white hover:text-blue-400 transition-colors">About</a>
          <a href="#technologies" onClick={() => setIsMobileMenuOpen(false)} className="text-2xl font-bold text-white hover:text-blue-400 transition-colors">Tech</a>
          <a href="#projects" onClick={() => setIsMobileMenuOpen(false)} className="text-2xl font-bold text-white hover:text-blue-400 transition-colors">Projects</a>
          <a href="#skills" onClick={() => setIsMobileMenuOpen(false)} className="text-2xl font-bold text-white hover:text-blue-400 transition-colors">Skills</a>
          <a href="#education" onClick={() => setIsMobileMenuOpen(false)} className="text-2xl font-bold text-white hover:text-blue-400 transition-colors">Education</a>
          <a href="#achievements" onClick={() => setIsMobileMenuOpen(false)} className="text-2xl font-bold text-white hover:text-blue-400 transition-colors">Achievements</a>
          <a href="#contact" onClick={() => setIsMobileMenuOpen(false)} className="px-8 py-3 rounded-full bg-gradient-to-r from-purple-600 to-blue-500 text-white font-bold shadow-[0_0_15px_rgba(59,130,246,0.3)] mt-4">Let's Work Together</a>
        </div>
      </header>
      ...
      <main className="max-w-[1400px] mx-auto px-6 md:px-12 pt-36 space-y-28 pb-20 relative z-10">
        ...
        <section id="home" className="flex flex-col lg:flex-row items-center justify-between gap-16 scroll-mt-32">
          ...
          <div className="flex-1 space-y-6 z-10">
            ...
            {/* WRITING EFFECT: First name and surname start together, standard font */}
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight writing-effect">
              <span className="text-white mr-3">Alex</span>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 drop-shadow-[0_0_20px_rgba(59,130,246,0.6)]">
                Hembrom
              </span>
            </h1>
            ...
            {/* Work Summary Paragraph (Also starts writing at the same time) */}
            <div className="flex gap-5 pt-3">
              <div className="w-1.5 rounded-full bg-gradient-to-b from-blue-500 via-indigo-500 to-purple-500 shadow-[0_0_12px_rgba(59,130,246,0.6)] shrink-0 writing-effect"></div>
              <p className="text-base md:text-lg text-gray-300 max-w-3xl lg:max-w-4xl leading-relaxed writing-effect">
          ...
          <div className="relative w-full lg:w-1/2 flex justify-center items-center mt-8 lg:mt-0">
            {/* Standard image container size */}
            <div className="relative w-80 h-80 md:w-96 md:h-[26rem] flex items-center justify-center">

              {/* Core Center Glow (No Orbital Rings) */}
              <div className="absolute inset-2 bg-gradient-to-br from-purple-600 via-indigo-600 to-blue-600 blur-[90px] rounded-full pointer-events-none opacity-70 animate-pulse z-0"></div>

              {/* PERFECT BLENDING MASK: Radial blur centered perfectly to soften bottom and sides */}
            ...
            <div className="relative bg-[#13151F] rounded-[calc(2rem-1px)] p-10 md:p-16 h-full w-full overflow-hidden">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                <div className="lg:col-span-7 space-y-4">
                  ...
                  {/* APPLIED WRITING EFFECT HERE */}
                  <h2 className="text-3xl md:text-4xl font-bold text-white writing-effect">About Me</h2>
                  
                  {/* APPLIED WRITING EFFECT HERE */}
                  <p className="text-gray-400 leading-relaxed text-base md:text-lg max-w-xl pb-4 writing-effect">
        ...
        <section id="achievements" className="relative scroll-mt-32 transition-transform duration-500 hover:-translate-y-2 group z-10">
          <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-500 rounded-[2rem] blur-2xl opacity-0 group-hover:opacity-30 transition-opacity duration-500 -z-10"></div>
          ...
          <div className="relative p-[1px] rounded-[2rem] bg-gradient-to-br from-blue-500 to-purple-500 h-full w-full">
            <div className="relative bg-[#13151F] rounded-[calc(2rem-1px)] p-10 md:p-16 h-full w-full overflow-hidden">
              <div className="space-y-3 mb-12">
                ...
                <h2 className="text-4xl font-extrabold text-white tracking-tight">Achievements & Certifications</h2>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#1A1D2D] border border-gray-800 rounded-2xl p-6 relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-4 hover:border-gray-600 transition-colors">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <div className="flex flex-wrap items-center gap-3 mb-1">
                        <h3 className="text-white font-bold text-xl">Google Cloud Skills Boost</h3>
                      </div>
                      <p className="text-gray-400 text-sm leading-relaxed max-w-3xl">Participated in Google Cloud Skills Boost program, earning 50+ badges, including "Build, Train and Deploy ML Models with Keras on Google Cloud."</p>
                    </div>
                  </div>
                  
                  <div className="md:text-right shrink-0">
                    <a href="https://www.skills.google/public_profiles/f8e931d4-b817-49af-93a2-4573e49f0d2a" target="_blank" rel="noreferrer" className="px-4 py-1.5 bg-[#13151F] text-blue-400 rounded-full text-xs font-bold border border-gray-800 hover:border-blue-500 hover:bg-blue-500/10 transition-all inline-flex items-center gap-1.5 cursor-pointer">
                      View Profile
                ...
                <div className="bg-[#1A1D2D] border border-gray-800 rounded-2xl p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 hover:border-gray-600 transition-colors">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <div className="flex flex-wrap items-center gap-3 mb-1">
                        <h3 className="text-white font-bold text-xl">GUVI HCL Hackathon</h3>
                      </div>
                      <p className="text-gray-400 text-sm leading-relaxed max-w-3xl">Participated in the nationwide GUVI HCL Hackathon to build and deploy technical solutions.</p>
                    </div>
                  </div>
                  
                  <div className="md:text-right shrink-0">
                    <a href="https://drive.google.com/file/d/1re4ipHrd2KL5WCN_JBfl4bo1a5NsIQUv/view" target="_blank" rel="noreferrer" className="px-4 py-1.5 bg-[#13151F] text-blue-400 rounded-full text-xs font-bold border border-gray-800 hover:border-blue-500 hover:bg-blue-500/10 transition-all inline-flex items-center gap-1.5 cursor-pointer">
                      View Certificate
                      <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
                    </a>
                  </div>
                ...
                <div className="bg-[#1A1D2D] border border-gray-800 rounded-2xl p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 hover:border-gray-600 transition-colors">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <div className="flex flex-wrap items-center gap-3 mb-1">
                        <h3 className="text-white font-bold text-xl">Core Member - GDG GCELT</h3>
                      </div>
                      <p className="text-gray-400 text-sm leading-relaxed max-w-3xl">Core member of the Web Development and Photography Team at GDG GCELT, responsible for building web solutions and capturing event highlights.</p>
                    </div>
                  </div>
                  
                  <div className="md:text-right shrink-0">
                    <a href="https://drive.google.com/drive/u/0/folders/1FbGGi7NuWCx8EVq8jaGFe86Y8xMoLtRb" target="_blank" rel="noreferrer" className="px-4 py-1.5 bg-[#13151F] text-blue-400 rounded-full text-xs font-bold border border-gray-800 hover:border-blue-500 hover:bg-blue-500/10 transition-all inline-flex items-center gap-1.5 cursor-pointer">
                      View Certificate
                      <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
                    </a>
                  </div>
      ...
      <footer className="max-w-[1400px] mx-auto px-6 md:px-12 py-8 border-t border-gray-800 flex flex-col md:flex-row items-center justify-between gap-4 relative z-10">
        ...
        <div className="flex items-center gap-4 text-gray-400">
          <a href="https://www.linkedin.com/in/alex-hembrom" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
          </a>
          <a href="https://github.com/alex-hembrom" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">
