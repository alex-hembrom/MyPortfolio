...
function App() {
  return (
    <div className="min-h-screen bg-background font-sans text-gray-200 selection:bg-purple-500 selection:text-white relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden opacity-[0.05] flex justify-between flex-wrap p-12">
        {/* Database */}
        <svg className="w-16 h-16 text-blue-400 absolute top-[10%] left-[5%] animate-bounce duration-[8s]" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 4.02 2 6.5v11C2 19.98 6.48 22 12 22s10-2.02 10-4.5v-11C22 4.02 17.52 2 12 2zM12 4c4.69 0 8 1.5 8 2.5s-3.31 2.5-8 2.5-8-1.5-8-2.5S7.31 4 12 4z"/></svg>
        {/* Node.js */}
        <svg className="w-16 h-16 text-green-400 absolute top-[20%] right-[10%] animate-pulse" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L2 7.8V16.2L12 22L22 16.2V7.8L12 2z"/></svg>
        {/* React */}
        <svg className="w-20 h-20 text-blue-400 absolute top-[40%] left-[8%]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><ellipse cx="12" cy="12" rx="10" ry="4" transform="rotate(30 12 12)"></ellipse><ellipse cx="12" cy="12" rx="10" ry="4" transform="rotate(90 12 12)"></ellipse><ellipse cx="12" cy="12" rx="10" ry="4" transform="rotate(150 12 12)"></ellipse></svg>
        {/* AI Chip */}
        <svg className="w-16 h-16 text-purple-400 absolute top-[55%] right-[6%]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m16-6h2m-2 6h2M7 5h10a2 2 0 012 2v10a2 2 0 01-2 2H7a2 2 0 01-2-2V7a2 2 0 012-2z"/></svg>
        {/* Code / VS Code */}
        <svg className="w-16 h-16 text-blue-300 absolute top-[75%] left-[4%]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"/></svg>
        {/* Firebase / Flame */}
        <svg className="w-16 h-16 text-yellow-400 absolute top-[85%] right-[12%]" fill="currentColor" viewBox="0 0 24 24"><path d="M13.5 2a.5.5 0 0 0-.5.5v3.25L10 2.5a.5.5 0 0 0-.85.35v6.9L6 6.5a.5.5 0 0 0-.8.4v10.6a6.5 6.5 0 0 0 13 0V7.5a.5.5 0 0 0-.8-.4l-3.9 3.25V2.5a.5.5 0 0 0-.5-.5z"/></svg>
      </div>
      ...
      <style>
        {`
          ...
          .animate-print {
            animation: printReveal 1.5s cubic-bezier(0.4, 0, 0.2, 1) forwards;
          }
          .animate-print-delayed {
            opacity: 0;
            animation: printReveal 1.5s cubic-bezier(0.4, 0, 0.2, 1) 0.5s forwards;
          }
        `}
      </style>
          ...
          <div className="flex-1 space-y-6 z-10">
            ...
            <div className="flex gap-5 pt-3">
              ...
              <p className="text-base md:text-lg text-gray-300 max-w-3xl lg:max-w-4xl leading-relaxed animate-print-delayed">
                Computer Science Engineering graduate specializing in modern full-stack development, interactive web applications, and intuitive user experiences. Experienced in building high-performance, scalable cross-platform systems using React, React Native, FastAPI, and intelligent AI integrations to transform complex problem statements into elegant digital products.
              </p>
            </div>
            ...
            <div className="relative bg-[#13151F] rounded-[calc(2rem-1px)] p-10 md:p-16 h-full w-full overflow-hidden">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                <div className="lg:col-span-7 space-y-4">
                  ...
                  <p className="text-gray-400 leading-relaxed text-base md:text-lg max-w-xl pb-4 animate-print">
                  ...
                  <button className="px-6 py-3 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-medium transform hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(59,130,246,0.5)] transition-all duration-300 text-sm flex items-center gap-2 border-none">
                    Download CV
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/></svg>
                  </button>
                </div>

                <div className="lg:col-span-5 bg-[#1A1D2D] border border-gray-800 rounded-2xl p-8 shadow-xl">
                  <div className="space-y-6">
                    <div className="flex items-center gap-4">
                      <div className="p-3 bg-[#13151F] rounded-xl text-gray-400 group-hover:text-blue-400 transition-colors">
            ...
            <div className="relative bg-[#13151F] rounded-[calc(2rem-1px)] p-10 md:p-16 h-full w-full overflow-hidden">
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6">
                  ...
                  {/* MongoDB Card */}
                  <div className="bg-[#1A1D2D] border border-gray-800 rounded-2xl p-6 flex flex-col items-center justify-center gap-4 hover:border-blue-500/50 transform hover:-translate-y-2 hover:shadow-[0_0_20px_rgba(59,130,246,0.25)] transition-all duration-300 cursor-pointer">
                  ...
                  {/* Firebase Card */}
                  <div className="bg-[#1A1D2D] border border-gray-800 rounded-2xl p-6 flex flex-col items-center justify-center gap-4 hover:border-blue-500/50 transform hover:-translate-y-2 hover:shadow-[0_0_20px_rgba(59,130,246,0.25)] transition-all duration-300 cursor-pointer col-span-2 sm:col-span-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="relative group/card transition-all duration-500 hover:-translate-y-2 z-10">
                  ...
                  <div className="bg-[#1A1D2D] border border-gray-800 group-hover/card:border-blue-500/50 rounded-2xl p-6 flex flex-col gap-4 h-full transition-colors duration-500">
                    <div className="w-full h-56 bg-[#13151F] rounded-xl relative overflow-hidden flex items-center justify-center border border-gray-800/50">
                      <span className="text-gray-600 text-sm font-medium">Crypto Wallet Screenshot</span>
                      <a href="#" className="absolute top-3 right-3 p-2 bg-black/50 backdrop-blur-sm rounded-lg text-white opacity-0 group-hover/card:opacity-100 transition-opacity">
          ...
          <div className="relative p-[1px] rounded-[2rem] bg-gradient-to-br from-blue-500 to-purple-500 h-full w-full">
            <div className="relative bg-[#13151F] rounded-[calc(2rem-1px)] p-8 md:p-14 h-full w-full overflow-hidden">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-[#1A1D2D] border border-gray-800 rounded-2xl p-6 shadow-xl flex flex-col justify-between hover:border-blue-500/50 transform hover:-translate-y-2 hover:scale-[1.02] hover:shadow-[0_0_25px_rgba(59,130,246,0.3)] transition-all duration-300 group/item cursor-pointer">
                  <div>
                    <div className="flex items-center gap-3 mb-4">
                      <div className="p-2.5 bg-blue-500/10 text-blue-400 rounded-xl transform group-hover/item:-translate-y-1 transition-transform duration-300">
          ...
          <div className="relative p-[1px] rounded-[2rem] bg-gradient-to-br from-blue-500 to-purple-500 h-full w-full">
            <div className="relative bg-[#13151F] rounded-[calc(2rem-1px)] p-10 md:p-16 h-full w-full overflow-hidden">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="bg-[#1A1D2D] border border-gray-800/50 rounded-2xl p-8 shadow-xl">
                  <form className="space-y-4">
                    ...
                    <button 
                      type="button" 
                      className="w-full py-3.5 rounded-xl bg-gradient-to-r from-blue-500 to-accent-purple text-white font-bold tracking-wide flex items-center justify-center gap-2 hover:opacity-90 transition-opacity"
                    >
                      Send Message
